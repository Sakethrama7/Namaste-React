...
/* Method-3 
 This is based on live data for 1 restaurant.
...
// Method-4
// Here we are using Mutliple Restuarants and also we are Optimizing the code.
...
const Body = () => {
  return (
    <div className="body">
      ...
      <div className="res-container">
        {
          /* Here Instead of repeatedly writing for many times we can use map.
